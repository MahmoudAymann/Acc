...
namespace Limra
{
    public partial class StoreSupplyOrders : Form
    {
        ...
        private void StoreSupplyOrders_Load(object sender, EventArgs e)
        {
        ...
        private void resizeGridView1(){
            ...
            dataGridView1.Columns[0].HeaderText = "رقم التوريد";
        ...
        private void loadDataIntoGridView1()
        {
            try{
                con.Open();
                cmd.CommandText = "SELECT * FROM StoreSupplyOrders";
                cmd.Connection = con;
        ...
        private void insertData(){
            ...
            {
                con.Open();
                cmd.CommandText = "INSERT INTO StoreSupplyOrders VALUES(@supplyDocNum, @date, @accNum, @accName, @storeNum, @storeName," +
        ...
        private void deleteCompanyInfoItems()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "TRUNCATE TABLE StoreSupplyOrders";
                cmd.ExecuteNonQuery();
        ...
        {
            SqlCommand cmd2 = new SqlCommand("INSERT INTO StoreSupplyOrders (supplyDocNum, date, accNum, accName, storeNum, storeName," +
                "groupNum,itemNum,itemName,package,quantity,cost,totalCost," +
                "description,totalSum,refrencerNumber)" +
