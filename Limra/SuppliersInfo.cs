...
namespace Limra
{
    public partial class SuppliersInfo : Form
    {
        ...
        private void resizeGridView1()
        {
            ...
            dataGridView1.Columns[1].HeaderText = "رقم حساب المورد";
        ...
        private void loadDataIntoGridView1()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "SELECT * FROM SuppliersData";
                cmd.Connection = con;
        ...
        private void insertData()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "INSERT INTO SuppliersData VALUES(@id, @accNum, @nameArabic, @address, @phone," +
        ...
        private void deleteCompanyInfoItems()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "TRUNCATE TABLE SuppliersData";
                cmd.ExecuteNonQuery();
        ...
        {
            SqlCommand cmd2 = new SqlCommand("Insert into SuppliersData(id, accNum, nameArabic, address, phone,nameEnglish" +
        ...
        private void editFunction()
        {
            ...
            try
            {
                string sqlquery = "UPDATE SuppliersData SET accNum = @accNum, " +
