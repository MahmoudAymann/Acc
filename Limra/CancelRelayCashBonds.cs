...
namespace Limra
{
    public partial class CancelRelayCashBonds : Form
    {
        ...
        private void loadDataIntoGridView1()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "SELECT DISTINCT docId, enterDate FROM RelayVoucherOfExchange WHERE boxNum=@boxNum";
                cmd.Connection = con;
        ...
        private void loadDataIntoGridView2() //dy 34an button send all
        {
        ...
        private void loadDataIntoGridViewBoxes()
        {
                ...
                try
                {
                    con.Open();
                    cmd = new SqlCommand();
                    cmd.CommandText = "SELECT DISTINCT boxNum, boxName FROM RelayVoucherOfExchange;";
                    cmd.Connection = con;
