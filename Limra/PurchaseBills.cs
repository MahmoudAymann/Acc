...
namespace Limra
{
    public partial class PurchaseBills : Form
    {
        ...
        private void loadDataIntoGridView1Cash()
        {
            ...
            {
                con.Open();
                //cmd.CommandText = "SELECT * FROM PurchaseBills";
                cmd.CommandText = "SELECT id,currentDate,kind,accountNum,accountName,currency," +
                    ...
                    "agentPhone,debitLimit FROM PurchaseBills WHERE kind = @kind ";
                cmd.Connection = con;
        ...
        private void insertDataPostponment()
        {
            try
            {
                con.Open();
                cmd.CommandText =
                "INSERT INTO PurchaseBills (id,currentDate,kind,payDate,currency," +
        ...
        private void insertDataCash()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "INSERT INTO PurchaseBills (id, currentDate, kind, accountNum, accountName, currency," +
                " agentName, description, itemNum, itemName, measruingUnit, quantity," +
                "singleCost,singleTotalCost,agentPhone,debitLimit)" +
        ...
        private void insertDataChique()
        {
            ...
            {
                con.Open();
                cmd.CommandText = "INSERT INTO PurchaseBills (id, currentDate, kind,chequeNum ,chequeAmount,currency," +
                   " agentName, description, itemNum, itemName, measruingUnit, quantity," +
                   "singleCost, singleTotalCost, agentPhone, debitLimit)" +
