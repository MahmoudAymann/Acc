...
namespace Limra
{
    ...
    {
        private const string strconneciton = @"Data Source=SPECTRA5;Initial Catalog=Limra;Integrated Security=True;TrustServerCertificate=False;MultipleActiveResultSets=true";
